<html>
    ...
    <body bgcolor="#FFB6C1">
        ...
        <center><h2>Teacher Book Issue</h2></center>
</br>
        ...
        ?>
            ...
            echo "No Reord Found";
               ?>
                ...
                <center><h2><u>Update Issued Book and Teacher Info </u></h2></center>
        <form action="teacher_bookissue_validation.php" method="POST">
            <table border="1" align="center" cellpadding="5" cellspacing="5">
